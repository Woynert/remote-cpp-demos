...
@XmlRegistry public class ObjectFactory
{
	...
	private final static QName _GetSongStorage_QNAME =
		new QName ("http://soap.server.simple/", "getSongStorage");
	private final static QName _GetSongByIdResponse_QNAME =
		new QName ("http://soap.server.simple/", "getSongByIdResponse");
	private final static QName _GetSongById_QNAME =
		new QName ("http://soap.server.simple/", "getSongById");
	private final static QName _GetSongStorageResponse_QNAME =
		new QName ("http://soap.server.simple/", "getSongStorageResponse");
	private final static QName _GetSongAmount_QNAME =
		new QName ("http://soap.server.simple/", "getSongAmount");
	private final static QName _GetSongAmountResponse_QNAME =
		new QName ("http://soap.server.simple/", "getSongAmountResponse");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes
	 * for package: simple.generated.soap
	 *
	 */
	 ...
	 *
	 */
	public GetSongStorage createGetSongStorage () { return new GetSongStorage (); }

	/**
	 * Create an instance of {@link GetSongByIdResponse }
	 *
	 */
	public GetSongByIdResponse createGetSongByIdResponse () { return new GetSongByIdResponse (); }

	/**
	 * Create an instance of {@link GetSongById }
	 *
	 */
	public GetSongById createGetSongById () { return new GetSongById (); }
	 ...
	 *
	 */
	public GetSongAmount createGetSongAmount () { return new GetSongAmount (); }
	 ...
	 *
	 */
	public Storage createStorage () { return new Storage (); }
	...
	{
		return new JAXBElement<GetSongStorage> (
			_GetSongStorage_QNAME, GetSongStorage.class, null, value);
	}
	...
	{
		return new JAXBElement<GetSongByIdResponse> (
			_GetSongByIdResponse_QNAME, GetSongByIdResponse.class, null, value);
	}
	...
	public JAXBElement<GetSongStorageResponse>
	createGetSongStorageResponse (GetSongStorageResponse value)
	{
		return new JAXBElement<GetSongStorageResponse> (
			_GetSongStorageResponse_QNAME, GetSongStorageResponse.class, null, value);
	}
	...
	{
		return new JAXBElement<GetSongAmount> (
			_GetSongAmount_QNAME, GetSongAmount.class, null, value);
	}
	...
	public JAXBElement<GetSongAmountResponse>
	createGetSongAmountResponse (GetSongAmountResponse value)
	{
		return new JAXBElement<GetSongAmountResponse> (
			_GetSongAmountResponse_QNAME, GetSongAmountResponse.class, null, value);
	}
}
